        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Form Text Box -->
                    <!-- Page Heading -->
                    <form class="col row-cols-lg-auto g-4 align-items-center" method="POST" action="<?php echo site_url('admin/Tiket/Updates') ?>">
                        ...
                        <div class="row mb-3 ml-12">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php foreach ($penyebab as $key => $values) { ?>
                                    <option value="<?php echo $values->NAMA_SUBMASALAH ?>"><?php echo $values->NAMA_SUBMASALAH; ?></option>
                        ...
                        <div class="col-8 text-center">
                            ...
                            <a class="col-3  btn btn-danger" href="<?php echo site_url('admin/dashboard'); ?>" role="button">Kembali</a>
                        </div>
                    </form>
